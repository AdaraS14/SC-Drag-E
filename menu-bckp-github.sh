...
link="https://raw.githubusercontent.com/AdaraS14/SC-Drag-E/userbackup/main/$NameUser/$NameUser.zip"
sleep 1
...
cekdata=$(curl -sS https://raw.githubusercontent.com/AdaraS14/SC-Drag-E/userbackup/main/$NameUser/$NameUser.zip | grep 404 | awk '{print $1}' | cut -d: -f1)
...
mkdir -p /root/backup
wget -q -O /root/backup/backup.zip "https://raw.githubusercontent.com/AdaraS14/SC-Drag-E/userbackup/main/$NameUser/$NameUser.zip" &> /dev/null
