...
# status
rm -rf /root/status
wget -q -O /root/status "https://raw.githubusercontent.com/AdaraS14/SC-Drag-E/main/statushariini"
...
CEKEXPIRED () {
        ...
        Exp1=$(curl -sS https://raw.githubusercontent.com/https://raw.githubusercontent.com/AdaraS14/Ip-permision/main/ipmini | grep $MYIP | awk '{print $3}')
        if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl -sS https://raw.githubusercontent.com/https://raw.githubusercontent.com/AdaraS14/Ip-permision/main/ipmini | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
CEKEXPIRED
else
...
Name=$(curl -sS https://raw.githubusercontent.com/https://raw.githubusercontent.com/AdaraS14/Ip-permision/main/ipmini | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/https://raw.githubusercontent.com/AdaraS14/Ip-permision/main/ipmini | grep $MYIP | awk '{print $3}')
